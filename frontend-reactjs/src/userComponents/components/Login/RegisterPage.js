...
function RegisterPage() {
  ...
  const handleSubmitButton = useCallback((e) => {
    // console.log("add event listener to submit button: ", Email);
          ...
          <div className="LogInPage__LeftWrapper-sc-1lupdgi-3 heZZjo">
            <div className="LogInPage__FormWrapper-sc-1lupdgi-1 fBwYea">
              <div data-testid="@account/login-form" className="LoginOrSignupForm__RootWrapper-sc-x0p9og-0 gihzRa">
                <div className="styled__Header-sc-1uh77v9-0 lefydX">
                  ...
                  {/* <svg viewBox="0 0 167 31" fill="none" xmlns="http://www.w3.org/2000/svg" className="styled__Logo-sc-1uh77v9-1 blvoFj">
                  ...
                  <h1 className="styled__Title-1">Create your account</h1>
                  <h2 className="styled__Subtitle-1">Create videos with a single click</h2>
                </div>
                <div className="LoginOrSignupForm__StyledForm-sc-x0p9og-1 eiWYJH">
                  <button type="button" className="OAuthGoogle__GoogleButton-sc-1m9c8rv-0 exHBLP">
                    <svg className="OAuthGoogle__logo" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 48 48" width="32" height="32">
                      <defs>
                        <path
                          id="a"
                  ...
                  <div className="Input__RootWrapper-sc-mdxq3k-0 kdZnns LoginOrSignupForm__StyledInput-sc-x0p9og-5 irApWU">
                    <input
                      ...
                      value={Email}
                    />
                    <label className="Input__Label-sc-mdxq3k-1 bdYPll">Or create a new account here</label>
                  </div>
                  <div className="Input__RootWrapper-sc-mdxq3k-0 kdZnns LoginOrSignupForm__StyledInput-sc-x0p9og-5 irApWU">
                    <input
                  ...
                  <button className="SignUp-Button" ref={submitButton}>
                    Register now !
                  </button>
                ...
                <div className="FormStyled__Footer-sc-67n526-6 dCuQEf">
                  ...
                  <Link className="styled__BlueLink-sc-1uh77v9-4 hRKVQr" to='/dev_login'>
                    Sign in
                  </Link>
                </div>
              </div>
