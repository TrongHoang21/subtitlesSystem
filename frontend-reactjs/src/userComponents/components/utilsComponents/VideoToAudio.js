//Based on: https://www.npmjs.com/package/video-to-audio
//Support return content of wav, instead of only url

const convert = function (videoFileData, targetAudioFormat) {
    try {
